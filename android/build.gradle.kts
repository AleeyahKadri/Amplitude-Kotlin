...
extra["PUBLISH_NAME"] = "Amplitude Android Kotlin SDK"
extra["PUBLISH_DESCRIPTION"] = "Amplitude Kotlin client-side SDK for Android"
extra["PUBLISH_ARTIFACT_ID"] = "analytics-android"
...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "AMPLITUDE_VERSION", "\"${project.version}\"")
